...
function hideCalendar(){
    document.getElementById('arrowdowncalendar').style.display='block'
    document.getElementById('arrowupcalendar').style.display='none'
}

function showHospedes(){
    document.getElementById('arrowdownhospedes').style.display='none'
    document.getElementById('arrowuphospedes').style.display='block'
}
